            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    @endif
                            ...
                            <form  method="post" action="http://localhost/boipotro.com/public/home/store" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1">Book Name</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Book Name" name="bookname">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea type="text" name="description" class="form-control" id="exampleInputEmail1" placeholder="Description">
                                </textarea>
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Price in Tk" name="price">
