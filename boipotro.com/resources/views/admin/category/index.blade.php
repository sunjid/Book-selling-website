        ...
        <div class="contact-form-area">
            <div class="container">
                <div class="about-title">
                    <button class="btn btn-default"><a href="category/show">View All Categories</a></button><br><br><br>
                    <button class="btn btn-default"><a href="category/create">Create Categories</a></button>
                </div>
